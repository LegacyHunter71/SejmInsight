...
// Mockowe dane do wizualizacji statystyk z dokumentacji (frekwencja klubów)
const mockAttendanceData = [
  { name: "KO", frekwencja: 95 },
  { name: "PiS", frekwencja: 92 },
  { name: "TD", frekwencja: 96 },
  { name: "Lewica", frekwencja: 98 },
  { name: "Konfederacja", frekwencja: 91 },
];
    ...
    <div className="p-8 space-y-8 w-full">
      <div className="space-y-2">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Najważniejsze wydarzenia i statystyki Sejmu RP X kadencji.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm transition-colors">
          <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">
            Średnia frekwencja klubów parlamentarnych (%)
          </h2>
